          ...
          <Card>
            <CardContent className="p-6 space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold mb-3">2. Advertising</h2>
                  <p className="text-muted-foreground mb-3">
                    This website displays Google AdSense advertisements. Google AdSense may use cookies and web beacons to:
                  </p>
                  <ul className="space-y-2 text-muted-foreground">
                    <li>• Serve personalized ads based on your browsing history</li>
                    <li>• Track ad impressions and interactions</li>

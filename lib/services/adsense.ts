...
class AdSenseService {
  ...
  private readonly maxAdsPerPage = 3;
  private adsCount = 0;
  ...
  public canAddMoreAds(): boolean {
    return this.adsCount < this.maxAdsPerPage;
  }

  public incrementAdsCount(): void {
    this.adsCount++;
  }

  public resetAdsCount(): void {
    this.adsCount = 0;
  }
}
